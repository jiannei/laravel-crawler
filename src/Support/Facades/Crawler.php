 ...
 * @method static \Jiannei\LaravelCrawler\Crawler contentXml()
 * @method static \Jiannei\LaravelCrawler\Crawler contentHtml()
 * @method static array|Collection                pattern(array $pattern)
 * @method static array|Collection                json(string $url)
